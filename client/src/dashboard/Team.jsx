    ...
    return (
        <div className="flex flex-col w-full h-full justify-start bg-white border border-gray-300 rounded-2xl py-4">
            <div className="flex items-center justify-between pb-4 px-6 mb-4 border-b border-gray-300">
                ...
                <button onClick={() => alert("Hello there! I see you came from Siege. Well, I'm unfortunately still working on this functionality and it's not quite ready yet (I didn't have enough time to finish by the end of the month).")} className="cursor-pointer px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium transition flex items-center gap-2">
