    ...
    return (
        <div className="bg-[#eff1ea] flex h-screen">
            ...
            <div className="w-[52px] h-full bg-transparent flex flex-col items-center">
                ...
                <div onClick={() => alert("Hello there! I see you came from Summer of Making. Well, I'm unfortunately still working on this functionality and it's not quite ready yet (I didn't have enough time to finish by the end of the month).")} className={`size-10 mt-3 cursor-pointer flex justify-center items-center rounded-lg border border-transparent ${page === 'outbound' ? 'bg-white shadow-md' : 'hover:bg-white/50 hover:border-gray-400/30 transition'}`}>
                ...
                <div className="bg-transparent mt-auto flex flex-col justify-center items-center w-full mb-4">
                    ...
                    <Dropdown type="profile" position="bottom-2 left-[52px]" open="onMouseEnter" className="size-10 mt-4 cursor-pointer rounded-full bg-white">
                        ...
                        <div className="menu">
                            ...
                            <button onClick={() => alert("Hello there! I see you came from Summer of Making. Well, I'm unfortunately still working on this functionality and it's not quite ready yet (I didn't have enough time to finish by the end of the month).")} className="w-full text-left px-3 py-2 rounded-lg hover:bg-gray-100 flex items-center gap-1">
                            ...
                            <button onClick={() => alert("Hello there! I see you came from Summer of Making. Well, I'm unfortunately still working on this functionality and it's not quite ready yet (I didn't have enough time to finish by the end of the month).")} className="w-full min-w-max text-left px-3 py-2 rounded-lg hover:bg-gray-100 flex items-center gap-1">
                                <svg className="w-5 h-5 text-gray-600 mt-[2px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
