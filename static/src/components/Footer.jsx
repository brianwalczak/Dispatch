    ...
    return (
        <footer className="bg-red-500/60 py-5">
            <div className="text-center text-white text-base">
                <p><b>&copy; {new Date().getFullYear()} Dispatch. All rights reserved.</b> | Made with <span className="text-red-500">&hearts;</span> by <a href="https://brian.re/" className="underline">Brian Walczak</a>.</p>
