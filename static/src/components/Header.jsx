...
const Header = React.forwardRef((props, ref) => (
  <header ref={ref} className="shadow-md fixed top-0 left-0 w-full z-50 bg-black/50 backdrop-blur-lg border-b border-gray-400/0 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <Link to="/dashboard" className="md:inline-block bg-red-600 text-white font-semibold py-2 px-4 rounded-lg shadow hover:bg-red-700 transition">Get Started</Link>
        </div>
    </header>
));
