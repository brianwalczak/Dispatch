        ...
        <>
            <main className="flex items-center justify-start flex-col text-center px-4 min-h-screen glow glow-orange pt-70 border-b border-gray-400/30">
                <div className="animated animatedFadeInUp fadeInUp">
                    ...
                    <Link to="https://app_dispatch.brian.icu/" className="md:inline-block bg-red-600 text-white font-semibold py-3 px-6 rounded-lg shadow hover:bg-red-700 transition">Get Started</Link>
